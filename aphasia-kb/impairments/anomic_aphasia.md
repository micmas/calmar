...
short_definition: The mildest aphasia syndrome, characterized predominantly by word-finding
  difficulty (anomia) with relatively preserved fluency, comprehension, and repetition.
  Often the residual stage that other aphasia types resolve into during recovery.
assessment:
...
source: agent_draft
last_reviewed: null
notes: 'Re-extraction draft from Yourganov 2015. Anomic aphasia is a
